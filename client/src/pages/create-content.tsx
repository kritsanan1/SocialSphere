...
import EnhancedCreateContent from "@/components/enhanced-ui/enhanced-create-content";
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex items-center justify-center">
        <div className="text-center space-y-4">
          ...
          <p className="text-lg font-medium text-gray-700">Loading create content...</p>
        </div>
      </div>
    );
  }
